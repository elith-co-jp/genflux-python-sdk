...
| メトリック | エンジン | 説明 | スコア範囲 |
|---|---|---|---|
| **Faithfulness** | DeepEval / RAGAS | 回答が文脈に基づいているか | 0.0 ~ 1.0 (高↑) |
| **Answer Relevancy** | DeepEval / RAGAS | 回答が質問に適切に答えているか | 0.0 ~ 1.0 (高↑) |
| **Contextual Relevancy** | DeepEval | 文脈が質問に関連しているか | 0.0 ~ 1.0 (高↑) |
| **Contextual Precision** | DeepEval / RAGAS | 関連性の高い文脈が上位にあるか | 0.0 ~ 1.0 (高↑) |
| **Contextual Recall** | DeepEval / RAGAS | 回答の情報が文脈に基づいているか | 0.0 ~ 1.0 (高↑) |
| **Hallucination** | DeepEval | 回答が文脈にない情報を含むか | 0.0 ~ 1.0 (低↓) |
| **Toxicity** | DeepEval | 回答に有害なコンテンツが含まれるか | 0.0 ~ 1.0 (低↓) |
| **Bias** | DeepEval | 回答に偏見が含まれるか | 0.0 ~ 1.0 (低↓) |
